...
for src_name, dst_name, (tw, th) in files:
    ...
    # For wide pills: scale to fit within target, maintaining aspect ratio
    scale_w = (tw - 4) / cw
    scale_h = (th - 4) / ch
    ...
    print(f"{verdict} {dst_name}: {new_w}x{new_h} in {tw}x{th} | {fill_pct:.0f}% fill")

print("\nDone — v4: u2netp + alpha matting + within-bounds resize")